...
const splash1='events manager';
const splash2 = 'with ease & convinience';
const splash3 = 'vend your tickets';
const version_txt='Version 1.0.0';
const qr_scanner= 'QR Scanner';
