...
class AppColors {
  ...
  static const Color background = Color(0xFFF5F7FA); // Light Gray-Blue background
  ...
  // Dark Theme Colors
  static const Color primaryColorDark = Color(0xFF2C5282); // Softer Navy for dark theme
  ...
  static const Color surfaceColorDark = Color(0xFF2D3748); // Slightly lighter surface
  static const Color errorDark = Color(0xFFEF5350);
  static const Color textPrimaryDark = Color(0xFFE2E8F0); // Light Gray-Blue text
  static const Color textSecondaryDark = Color(0xFFA0AEC0); // Muted Gray-Blue text
